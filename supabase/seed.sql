...
VALUES 
  ('11111111-1111-1111-1111-111111111111', 'こころ', 'The Heart', 'A classic Japanese novel exploring the complexities of human nature.', 'Intermediate', ARRAY['classic', 'literature'], 'https://example.com/heart.jpg', 'published'),
  ('22222222-2222-2222-2222-222222222222', '雪国', 'Snow Country', 'A novel about a love affair between a Tokyo dilettante and a provincial geisha.', 'Advanced', ARRAY['classic', 'literature', 'romance'], 'https://example.com/snow.jpg', 'published'),
  ('33333333-3333-3333-3333-333333333333', '君の名は', 'Your Name', 'A story about two strangers who mysteriously exchange bodies.', 'Beginner', ARRAY['modern', 'romance', 'fantasy'], 'https://example.com/yourname.jpg', 'published');
...
VALUES 
  ('11aaaaaa-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'https://example.com/panel1.jpg', 1),
  ('22aaaaaa-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'https://example.com/panel2.jpg', 2),
  ('33aaaaaa-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'https://example.com/panel3.jpg', 1),
  ('44aaaaaa-4444-4444-4444-444444444444', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'https://example.com/panel4.jpg', 1),
  ('55aaaaaa-5555-5555-5555-555555555555', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'https://example.com/panel5.jpg', 1);
...
-- Create a test admin user (if auth.users exists)
DO $$
BEGIN
  IF EXISTS (
    ...
    IF EXISTS (
      ...
      -- Set a role for an existing user if present (you'd need to replace the email)
      UPDATE auth.users
      SET role = 'admin'
